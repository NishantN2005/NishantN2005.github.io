...
function Home() {
  ...
  return (
    ...
    {/* Second Section */}
        ...
        <div className='relative bg-white'>
          <div className="py-16">
            ...
            <h2 className="text-5xl md:text-5xl font-bold text-[#013167] text-center">
    ...
    <div className=" relative bg-white py-10 text-[#013167]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-[#013167] mb-4">Frequently Asked Questions</h2>
    ...
    <div className="relative bg-white py-16">
      <h2 className="text-5xl text-left text-[#013167] font-bold mb-8 pl-10">
